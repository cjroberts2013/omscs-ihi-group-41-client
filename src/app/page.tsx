...
export default function page() {
    return (
      <main className="flex flex-col items-start min-h-screen bg-white text-black p-4">
        <h1 className="text-2xl text-left font-bold">Group 41 Team Project</h1>
        <p className="text-left text-mmed">Bryan Lopez, Jeffrey Pannell, Charles Roberts, Smita Tejo</p>
